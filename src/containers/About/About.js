            ...
            <div className="About-content container d-md-flex">
                ...
                <div className="about-content__comment">
                    <div className="ac__comment">
                        ...
                        <h1 className="About-content__title">Most trusted in our field</h1>
                        <p className="About-content__text">Most calendars are designed for teams. Slate is designed for freelancers who want a simple way to plan their schedule.</p>
