    ...
    return (
        <div className="container d-flex justify-content-center">
            <div className="header_content text-white ">
                ...
                <p className="header_content__paragraph mb-4">We know how large objects will act, but things on a 
small scale just do not act that way.</p>
            <div className="header_content__button justify-content-center">
